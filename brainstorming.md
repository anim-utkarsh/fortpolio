# Brainstorming: fortpolio

This document is the "sauce of tooth" for the project. It tracks ideas, rejected concepts, and the overall vision for the portfolio.
...
## ✅ Current Strategy (Synthesized Idea)
### "The Dig-Down Zine"
This is the current synthesis of the ideas above:
- **Interaction**: Vertical reverse-chronological scroll (Fossil Scroll).
- **Metaphor**: Case studies are "loose leaves" (Leaf Carrier) embedded in temporal layers.
- **Output**: Designed for printability (Zine).

## ❌ Rejected Ideas
_No ideas are rejected yet. We are keeping all concepts for reference._
